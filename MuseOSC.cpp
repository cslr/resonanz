...
bool MuseOSC::connectionOk() const
{
	...
	if((ms_since_epoch - latest_sample_seen_t) > 1000)
		return false; // latest sample is more than 1000ms second old => bad connection/data
	else
		return true; // sample within 1000ms => good
}
